...
request = function()
  ...
  local method = "POST"
  -- Since the nginx-thrift service is port-forwarded to the localhost, we use the localhost address here:
  local path = "http://10.0.2.2:8080/wrk2-api/post/compose"
  local headers = {}
  local body
